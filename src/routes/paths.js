...
export const PATH_DASHBOARD = {
  ...
  board: {
    ...
    postfree: path(ROOTS_DASHBOARD, '/board/free/:id'),
    postmotocycle: path(ROOTS_DASHBOARD, '/board/motocycle/:id'),
    postmotocycledix: path(ROOTS_DASHBOARD, '/board/motocyclefix/:id'),
    postmotocyclepicture: path(ROOTS_DASHBOARD, '/board/motocyclepicture/:id'),
